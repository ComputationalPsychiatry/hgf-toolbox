function c = tapas_bayes_optimal_whatworld_config
...
% Model name
c.model = 'Bayes optimal whatworld';
...
% Model filehandle
c.obs_fun = @tapas_bayes_optimal_whatworld;

% This is the handle to a dummy function since there are no parameters to transform
c.transp_obs_fun = @tapas_bayes_optimal_whatworld_transp;
