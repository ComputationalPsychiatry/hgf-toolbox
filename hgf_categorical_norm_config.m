function c = hgf_categorical_norm_config
...
% refer to hgf_config.m, for binary inputs, refer to hgf_binary.m
...
% Tips:
%   >> est = fitModel([], u, 'hgf_categorical_config', 'bayes_optimal_categorical_config');
...
c.prc_fun = @hgf_categorical;

% Handle to function that transforms perceptual parameters to their native space
% from the space they are estimated in
c.transp_prc_fun = @hgf_categorical_transp;
