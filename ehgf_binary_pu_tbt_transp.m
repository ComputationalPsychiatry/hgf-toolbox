function [pvec, pstruct] = ehgf_binary_pu_tbt_transp(r, ptrans)
% ehgf adaptation based on the function hgf_binary_pu_tbt_transp by Rebecca Lawson, Christoph Mathys, TNU, UZH & ETHZ
