...
% >> est = fitModel(y, u, 'hgf_ar1_mabt_config', 'softmax_config');
...
% Tips:
%   >> est = fitModel([], u, 'hgf_ar1_config', 'bayes_optimal_config');
...
c.prc_fun = @hgf_ar1_mab;

% Handle to function that transforms perceptual parameters to their native space
% from the space they are estimated in
c.transp_prc_fun = @hgf_ar1_mab_transp;
