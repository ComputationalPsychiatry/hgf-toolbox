function c = hgf_whatworld_config
...
% Tips:
%   >> est = fitModel([], u, 'hgf_whatworld_config', 'bayes_optimal_whatworld_config');
...
c.prc_fun = @hgf_whatworld;

% Handle to function that transforms perceptual parameters to their native space
% from the space they are estimated in
c.transp_prc_fun = @hgf_whatworld_transp;
