function [traj, infStates] = hgf_binary_pu_unified(r, p, varargin)
% Unified Hierarchical Gaussian Filter for binary inputs with perceptual uncertainty.
%
% This function implements both the standard HGF and the enhanced HGF (eHGF)
% for binary inputs with perceptual uncertainty. The update type is controlled
% by r.c_prc.update_type:
%   'hgf'  - Standard HGF
%   'ehgf' - Enhanced HGF (safe precision updates)
%
% This function can be called in two ways:
% (1) hgf_binary_pu_unified(r, p)
% (2) hgf_binary_pu_unified(r, ptrans, 'trans')
