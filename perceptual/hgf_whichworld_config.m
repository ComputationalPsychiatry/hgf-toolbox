function c = hgf_whichworld_config
...
% Tips:
%   >> est = fitModel([], u, 'hgf_whichworld_config', 'bayes_optimal_whichworld_config');
...
c.prc_fun = @hgf_whichworld;

% Handle to function that transforms perceptual parameters to their native space
% from the space they are estimated in
c.transp_prc_fun = @hgf_whichworld_transp;
