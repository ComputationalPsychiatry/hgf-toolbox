function [traj, infStates] = hgf_whatworld(r, p, varargin)
...
% (2) hgf_whatworld(r, ptrans, 'trans')
...
if ~isfield(r,'c_prc')
    error('tapas:hgf:ConfigRequired', 'Configuration required: before calling hgf_whatworld, hgf_whatworld_config has to be called.');
end

% Transform paramaters back to their native space if needed
if ~isempty(varargin) && strcmp(varargin{1},'trans');
    p = hgf_whatworld_transp(r, p);
end
