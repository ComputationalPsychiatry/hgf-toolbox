function hgf_whichworld_plotTraj(r)
...
if ~isfield(r,'c_prc')
    error('tapas:hgf:ConfigRequired', 'Configuration required: before calling hgf_whichworld_plotTraj, hgf_whichworld_config has to be called.');
end
