function hgf_whatworld_plotTraj(r)
...
if ~isfield(r,'c_prc')
    error('tapas:hgf:ConfigRequired', 'Configuration required: before calling hgf_whatworld_plotTraj, hgf_whatworld_config has to be called.');
end
