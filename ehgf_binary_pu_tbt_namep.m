function pstruct = ehgf_binary_pu_tbt_namep(pvec)
% ehgf adaptation based on the function hgf_binary_pu_tbt_namep by Rebecca Lawson, Christoph Mathys, TNU, UZH & ETHZ
