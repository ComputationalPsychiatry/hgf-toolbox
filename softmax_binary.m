function [logp, yhat, res] = softmax_binary(r, infStates, ptrans)
...
if size(r.u,2) ~= 1 && size(r.u,2) ~= 3
    error('tapas:hgf:SoftMaxBinary:InputsIncompatible', 'Inputs incompatible with softmax_binary observation model. See softmax_binary_config.m.')
end
