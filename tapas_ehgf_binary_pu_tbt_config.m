function c = tapas_ehgf_binary_pu_tbt_config
...
% ehgf adaptation based on the function tapas_hgf_binary_pu_tbt_config by Rebecca Lawson, Christoph Mathys, TNU, UZH & ETHZ
...
c.prc_fun = @tapas_ehgf_binary_pu_tbt;
