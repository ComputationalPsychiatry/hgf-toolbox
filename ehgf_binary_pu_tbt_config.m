function c = ehgf_binary_pu_tbt_config
...
% Tips:
%   >> est = fitModel([], u, 'hgf_binary_pu_tbt_config', 'bayes_optimal_binary_config');
...
% ehgf adaptation based on the function hgf_binary_pu_tbt_config by Rebecca Lawson, Christoph Mathys, TNU, UZH & ETHZ
...
c.transp_prc_fun = @ehgf_binary_pu_tbt_transp;
