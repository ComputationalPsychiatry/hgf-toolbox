function c = ehgf_binary_pu_config
...
% Tips:
%   >> est = fitModel([], u, 'hgf_binary_pu_config', 'bayes_optimal_binary_config');
...
c.transp_prc_fun = @ehgf_binary_pu_transp;
